                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  FadeAnimation(1, Text("Emma Wastson",style:
                      ...
                      delegate:SliverChildListDelegate([
                        Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              FadeAnimation(1.6,Text("Emma Charlotte Duerre Waston was born in Paris,France,to English parents,Jacqueline Luesby and Chris Waston,both lawyers.She moved to Oxfordshire when she was five,where she attended the Dragon School.",
